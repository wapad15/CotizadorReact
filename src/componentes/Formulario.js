...
export default class Formulario extends Component {
    ...
    //refs son para leer los valores de los campos de un formulario(se podrian hacer con el constructor )
    marcaRef = React.createRef();
    yearRef = React.createRef();
    planBasicoRef = React.createRef();
    planCompletoRef = React.createRef();
    
    //funcion para leer los daots del formulario ,arrow funtion para envitar undefined de clases
    cotizarSeguro = (e) => {
        e.preventDefault();
